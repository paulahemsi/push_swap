...
* 06/06: So, decided to implemented a index in my link list nodes, to better keep track of the numbers without always have to refeer to the ordered array. I implemented the firts part of the algorithm, and it's sorting small stacks.